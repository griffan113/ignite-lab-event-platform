...
import { LoadingSpinner, VideoPlayer } from '../../atoms';
...
export const LessonContent: React.FC<LessonContentProps> = ({ slug }) => {
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <p className="mt-4 text-gray-200 leadind-relaxed">{data?.lesson.description}</p>
